...
class ChatListState extends State<ChatList>
                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              "You don't have any approved groups yet. Create a new group or wait for approval on your pending requests.",
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey,
                              ),
  ...
  Future<List<Map<String, dynamic>>> _loadChats() async {
    ...
    for (var group in groups) {
      // Check if user is approved in this group
      final isApproved = await _isUserApproved(group['id']);
      if (!isApproved) continue; // Skip if not approved
